      ...
      <div class="archive-content">
        <div class="one_third">
          <div class="sitemap-pages">
            <h2>
              <?php esc_html_e('Pages','shine-fashion');?>
            </h2>
            <ul>
        ...
        <div class="one_third">
          <div class="sitemap-category">
            <h2>
              <?php esc_html_e( 'Category Archives','shine-fashion'); ?>
            </h2>
            <ul>
              <?php wp_list_categories( array( 'feed' => esc_html__( 'RSS', 'shine-fashion' ), 'show_count' => true, 'use_desc_for_title' => false, 'title_li' => false ) ); ?>
            </ul>
          </div>
          <div class="clear"></div>
          <div class="sitemap-month-archieves">
            <h2>
              <?php esc_html_e( 'Monthly Archives','shine-fashion'); ?>
            </h2>
            <ul>
          ...
          <div class="sitemap-authors">
            <h2>
              <?php esc_html_e( 'Author Archives','shine-fashion'); ?>
            </h2>
            <ul>
        ...
        <div class="one_third last">
          <div class="sitemap-posts">
            <h2>
              <?php esc_html_e( 'Blog Posts','shine-fashion'); ?>
            </h2>
            <ul>
              <?php 
				$archivesquery = new WP_Query('showposts=20');
				while ($archivesquery->have_posts()) : $archivesquery->the_post(); ?>
              <li> <a href="<?php the_permalink() ?>"  rel="bookmark" title="<?php printf( esc_html__("Permanent Link to %s", 'shine-fashion'), get_the_title() ); ?>">
                <?php the_title(); ?>
                </a> (
