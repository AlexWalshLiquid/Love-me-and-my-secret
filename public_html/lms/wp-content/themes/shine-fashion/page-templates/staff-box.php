    ...
    <div id="content" class="site-content" role="main">
      ...
      <div id="container" class="staff-box-container box-container">
        ...
        <div class="grid <?php echo esc_attr(tm_staff_box_columns_class()); ?>">
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
              ...
              <div class="entry-content">
                ...
                <div class="staff-social icon-<?php echo esc_attr($s);?>">
                  <?php
					 if(!empty($staff_link)) :  ?>
                  <a href="<?php echo esc_url($staff_link); ?>" title="<?php echo esc_html__('Website', 'shine-fashion');?>" class="website icon"><i class="fa fa-link"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_email)) :  ?>
                  <a href="<?php echo esc_url($staff_email); ?>" title="<?php echo esc_html__('Email', 'shine-fashion');?>" class="email icon"><i class="fa fa-envelope-o"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_twitter)) :  ?>
                  <a href="<?php echo esc_url($staff_twitter); ?>" title="<?php echo esc_html__('Twitter', 'shine-fashion');?>" class="twitter icon"><i class="fa fa-twitter"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_facebook)) :  ?>
                  <a href="<?php echo esc_url($staff_facebook); ?>" title="<?php echo esc_html__('Facebook', 'shine-fashion');?>" class="facebook icon"><i class="fa fa-facebook"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_google_plus)) :  ?>
                  <a href="<?php echo esc_url($staff_google_plus); ?>" title="<?php echo esc_html__('Google Plus', 'shine-fashion');?>" class="google-plus icon"><i class="fa fa-google-plus"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_linkedin)) :  ?>
                  <a href="<?php echo esc_url($staff_linkedin); ?>" title="<?php echo esc_html__('Linkedin', 'shine-fashion');?>" class="linkedin icon"><i class="fa fa-linkedin"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_youtube)) :  ?>
                  <a href="<?php echo esc_url($staff_youtube); ?>" title="<?php echo esc_html__('Youtube', 'shine-fashion');?>" class="youtube icon"><i class="fa fa-youtube"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_rss)) :  ?>
                  <a href="<?php echo esc_url($staff_rss); ?>" title="<?php echo esc_html__('RSS', 'shine-fashion');?>" class="rss icon"><i class="fa fa-rss"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_pinterest)) :  ?>
                  <a href="<?php echo esc_url($staff_pinterest); ?>" title="<?php echo esc_html__('Pinterest', 'shine-fashion');?>" class="pinterest icon"><i class="fa fa-pinterest"></i></a>
                  <?php endif; ?>
                  <?php if(!empty($staff_skype)) :  ?>
                  <a href="<?php echo esc_url($staff_skype); ?>" title="<?php echo esc_html__('Skype', 'shine-fashion');?>" class="skype icon"><i class="fa fa-skype"></i></a>
                  <?php endif; ?>
                </div>
              </div>
            </article>
          ...
          <p>
            <?php  esc_html__( 'Sorry, no posts matched your criteria.', 'shine-fashion' ); ?>
          </p>
          <?php endif; ?>
        </div>
        <?php // Post navigation.
