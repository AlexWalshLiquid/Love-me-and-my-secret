<header id="masthead" class="site-header style-1 <?php echo esc_attr(tm_sidebar_position()); ?> <?php echo esc_attr(tm_page_layout()); ?>" role="banner">
...
<span class="shipping-price"><em></em></span>
</div>
				  </div>
			
		      
				  <div class="header-contactus headercart-block">
						<?php 
									// Woo commerce Header Cart
									...
									<span class="shipping-text"><a class="" href="<?php echo esc_url($woocommerce->cart->get_cart_url()); ?>" title="<?php esc_html_e('View your shopping cart', 'shine-fashion'); ?>"><?php echo sprintf(_n('%d Item(s)', '%d Item', $woocommerce->cart->cart_contents_count, 'shine-fashion'), $woocommerce->cart->cart_contents_count);?><?php //echo $woocommerce->cart->get_cart_total(); ?></a></span>
                                    <span class="shipping-price"><br />&nbsp;&nbsp;</span>
                                    <?php global $woocommerce; ?>
	  ...
	  <div id="navbar" class="header-bottom navbar default">
							<nav id="site-navigation" class="navigation main-navigation" role="navigation">									
								...
								<div class="custom_category">
									<?php templatemela_get_widget('Nav-Menu'); ?>
								</div>
							</nav><!-- #site-navigation -->
		</div>
	</div>
