...
$options1[] = array("id" => "tmoption_button_color_opacity",
					"label" => "Buttons Color Opacity",
					"type" => "textbox",
					"std" => "0",
					"description" => "Change your button color opacity e.g. ( 0.1 to 1 ).")	;				
...
$options1[] = array("id" => "tmoption_button_hover_color_opacity",
					"label" => "Buttons Hover Color Opacity",
					"type" => "textbox",
					"std" => "0",
					"description" => "Change your button hover color opacity e.g. ( 0.1 to 1 ).")	;	
...
$options2[] = array("id" => "tmoption_header_layout",
					"label" => "Select your Header Layout",
					"type" => "select",
					"description" => "Select Your Header Layout.",
					"options" => array('style-1' => 'Style 1','style-2' => 'Style 2','style-3' => 'Style 3'));
...
$options3[] = array("id" => "tmoption_h2font",
					...
					"options" => array('Open+Sans'=>'Open Sans','Raleway'=>'Raleway','please-select'=>'please-select','Roboto Slab'=>'Roboto Slab','Nunito'=>'Nunito','Droid+Sans'=>'Droid Sans','Antic'=>'Antic','Bitter'=>'Bitter','Droid+Serif'=>'Droid Serif','Philosopher'=>'Philosopher','Oxygen'=>'Oxygen','Rokkitt'=>'Rokkitt','Galdeano'=>'Galdeano','Glegoo'=>'Glegoo','Oswald'=>'Oswald','Play'=>'Play','Cuprum'=>'Cuprum','Varela'=>'Varela','Andika'=>'Andika','Other+Fonts'=>'Other Fonts'));
...
$options6[] = array("id" => "tmoption_show_topbar_welcome",
					"label" => "Show Top Bar Welcome Message",
					"type" => "select",
					"description" => "Displays Top bar Welcome Message.",
					"options" => array('yes' => 'Yes','no' => 'No'));
					
$options6[] = array("id" => "tmoption_topbar_welcome_text",
					"label" => "Top Bar Welcome Message Text",
					"type" => "textbox",
					"std" => "Welcome To ",
					"description" => "Displays Top bar Welcome Message Text");						
...
$options6[] = array("label" => "Header Free Shipping",
					"title" =>"Header Free Shipping Settings",
					"type" => "Title-1");	
									
$options6[] = array("id" => "tmoption_show_free_shipping_block",
					"label" => "Show Free Shipping block",
					"type" => "select",
					"description" => "Displays Free Shipping Block.",
					"options" => array('yes' => 'Yes','no' => 'No'));	
					
$options6[] = array("id" => "tmoption_show_free_shipping_text",
					"label" => "Free Shipping Text",
					"std" => "FREE SHIPPING ON OVER",
					"type" => "textbox",
					"description" => "Please enter you free shipping text.");	
														
$options6[] = array("id" => "tmoption_show_free_shipping_price",
					"label" => "Free Shipping Price Limit",
					"std" => "$75",
					"type" => "textbox",
					"description" => "Please enter you free shipping price limit.");	
					
$options6[] = array("label" => "Content Banner",
					"title" =>"Content Banner Settings",
					"type" => "Title-1");
					
$options6[] = array("id" => "tmoption_custom_banner",
					"label" => "Show Content Banner",
					"type" => "select",
...
$options6[] = array("id" => "tmoption_custom_text1",
					"label" => "Custom Text 1",
					"std" => "Extra 20% Off on New Arrivals",
					"type" => "textbox",
					"description" => "Change your content banner text1.");
					
$options6[] = array("id" => "tmoption_custom_text1_desc",
					"label" => "Custom Text 1 desc",
					"std" => "No Minimum Purchase Value",
					"type" => "textbox",
					"description" => "Change your content banner text1 desc.");
				
$options6[] = array("id" => "tmoption_custom_text2",
					"label" => "Custom Text 2",
					"std" => "UPTO 80% Off + EXTRA 15% Off",
					"type" => "textbox",
					"description" => "Change your content banner text2.");	
						
$options6[] = array("id" => "tmoption_custom_text2_desc",
					"label" => "Custom Text 2 desc",
					"std" => "Happy Hours Extended",
					"type" => "textbox",
					"description" => "Change your content banner text2 desc.");
										
$options6[] = array("id" => "tmoption_custom_text3",
					"label" => "Custom Text 3",
					"std" => "Lakme Fashion Week Winter",
					"type" => "textbox",
					"description" => "Change your content banner text3.");
					
$options6[] = array("id" => "tmoption_custom_text3_desc",
					"label" => "Custom Text 3 desc",
					"std" => "what's trending the session",
					"type" => "textbox",
					"description" => "Change your content banner text3 desc.");	
...
<div id="tab-container" class='tab-container'>
  <ul class='etabs'>
    <li class="tab first"> <a href="#General" title="General Settings"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/general_setting.png" alt="general"/> <span class="title">
      <?php echo esc_html__('General','shine-fashion');?>
      </span></a> </li>
    <li class="tab topbar"> <a href="#Topbar"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/topbar_setting.png" alt="color"/> <span class="title">
      <?php echo esc_html__('Topbar','shine-fashion');?>
      </span></a> </li>
    <li class="tab header"> <a href="#Header"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/header_setting.png" alt="color"/> <span class="title">
      <?php echo esc_html__('Header','shine-fashion');?>
      </span></a> </li>
    <li class="tab"> <a href="#Content"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/content_settings.png" alt="color"/> <span class="title">
      <?php echo esc_html__('Content','shine-fashion');?>
      </span></a> </li>
    <li class="tab"> <a href="#Footer"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/footer_settings.png" alt="color"/> <span class="title">
      <?php echo esc_html__('Footer','shine-fashion');?>
      </span></a> </li>
    ...
    <li class="tab"> <a href="#shop"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/shop_setting.png" alt="blog"/> <span class="title">
      <?php echo esc_html__('Shop','shine-fashion');?>
      </span></a> </li>
	  <?php endif; ?>
  ...
  <div class='panel-container'>
	 ...
	 if(!isset( $_REQUEST['reset1'])) {$_REQUEST['reset1']=''; }
       if ( 'save_options1' == $_REQUEST['action'] )
       {
        ...
        <div class="background-title">
          <label>
          <?php echo esc_html__('General Settings', 'shine-fashion'); ?>
          </label>
        </div>
        <?php
       $i= 0;
    ...
    ?>
        ...
        <div class="background-title">
          <label>
          <?php echo esc_html__('Top header Settings', 'shine-fashion'); ?>
          </label>
        </div>
        <?php
     foreach ($options6 as $value) { 
...
<?php if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) : ?>
	...
	if(!isset( $_REQUEST['reset7'])) {$_REQUEST['reset7']=''; }	
     ...
     ?>
        ...
        <div class="background-title">
         <label>
            <?php echo esc_html__('Shop Settings', 'shine-fashion'); ?>
          </label>
        </div>
        <?php
        foreach ($options7 as $value) { 
if(!isset( $value['type'])) {$value['type']=''; }	
   ...
   ?>
    ...
    ?>
        ...
        <div class="background-title">
			<label>
          <?php echo esc_html__('Header Settings', 'shine-fashion'); ?>
		  	</label>
        </div>
        <?php
     foreach ($options2 as $value) { 
...
window.onload=function(){
    ...
    <div id="Content">
     ...
     ?>
        ...
        <div class="background-title">
          <label>
          <?php echo esc_html__('Content Settings', 'shine-fashion'); ?>
          </label>
        </div>
        <?php
        foreach ($options3 as $value) { 
   ...
   ?>
    ...
    ?>
        ...
        <div class="background-title">
          <label>
          <?php echo esc_html__('Footer Settings', 'shine-fashion'); ?>
          </label>
        </div>
        <?php
     foreach ($options4 as $value) { 
