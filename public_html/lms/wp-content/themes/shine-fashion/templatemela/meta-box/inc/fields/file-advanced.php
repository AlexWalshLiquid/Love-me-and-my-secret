	...
	class RWMB_File_Advanced_Field extends RWMB_File_Field
	{
		...
		static function admin_enqueue_scripts()
		{
			...
			wp_localize_script( 'rwmb-file-advanced', 'rwmbFileAdvanced', array(
				'frameTitle' => esc_html__( 'Select Files', 'shine-fashion' ),
			) );
		}
		...
		{
			$i18n_title  = apply_filters( 'rwmb_file_advanced_select_string', _x( 'Select or Upload Files', 'file upload', 'shine-fashion' ), $field );
