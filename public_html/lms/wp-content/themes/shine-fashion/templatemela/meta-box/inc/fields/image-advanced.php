...

	{
...

		{
			...
			wp_localize_script( 'rwmb-image-advanced', 'rwmbImageAdvanced', array(
				...
				'frameTitle' => esc_html__( 'Select Images', 'shine-fashion' ),
...

		{
			...
			$i18n_title = apply_filters( 'rwmb_image_advanced_select_string', _x( 'Select or Upload Images', 'image upload', 'shine-fashion' ), $field );
