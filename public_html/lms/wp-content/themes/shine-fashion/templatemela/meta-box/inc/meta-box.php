...

{
...

	{
...

		{
			...
			wp_enqueue_style( 'shine-fashion', RWMB_CSS_URL . 'style.css', array(), RWMB_VER );
				...
				echo '
...

					{
						...
						var rwmb = {
							...
							summaryMessage : "' . esc_html__( 'Please correct the errors highlighted below and try again.', 'shine-fashion' ) . '"
