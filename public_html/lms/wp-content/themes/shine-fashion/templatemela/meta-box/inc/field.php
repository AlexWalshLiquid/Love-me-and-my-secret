...
if ( !class_exists( 'RWMB_Field ' ) )
{
	class RWMB_Field
	{
		...
		static function end_html( $meta, $field )
		{
			...
			$button = '';
			if ( $field['clone'] )
				$button = '<a href="#" class="rwmb-button button-primary add-clone">' . esc_html__( '+', 'shine-fashion' ) . '</a>';
		...
		{
			return '<a href="#" class="rwmb-button button remove-clone">' . esc_html__( '&#8211;', 'shine-fashion' ) . '</a>';
		}
