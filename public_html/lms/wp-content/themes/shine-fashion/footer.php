  ...
  <div class="footer_inner">
	...
	<div class="footer-bottom-container">
	   ...
	   <div class="footer_center ">
			  ...
			  <!-- #footer-menu-links -->
			  <div class="site-info">  <?php esc_html__( 'Copyright', 'shine-fashion' ); ?> &copy; <?php echo esc_attr(date('Y')); ?> <a href="<?php echo esc_url(get_option('tmoption_footer_link')); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><?php echo esc_attr(get_option('tmoption_footer_slog'));?>
				</a>
				<?php do_action( 'templatemela_credits' ); ?> Website by <a href="http://www.liquidagency.co.uk/" target="_blank">Liquid.</a>
	    </div>
