...
function templatemela_paging_nav() {
	...
	<nav class="navigation paging-navigation" role="navigation">
		<h1 class="screen-reader-text"><?php esc_html_e( 'Posts navigation', 'shine-fashion' ); ?></h1>
...
function templatemela_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		<h1 class="screen-reader-text"><?php esc_html_e( 'Post navigation', 'shine-fashion' ); ?></h1>
		<div class="nav-links">
			<?php
			if ( is_attachment() ) :
				previous_post_link( '%link', wp_kses( __( '<span class="meta-nav">Published In</span>%title', 'shine-fashion' ),allowed_html()));
				  							
			else :
				previous_post_link( '%link', wp_kses( __( '<i class="fa fa-chevron-left"></i>%title', 'shine-fashion' ),allowed_html()));
				next_post_link( '%link', wp_kses( __( '%title<i class="fa fa-chevron-right"></i>', 'shine-fashion' ),allowed_html()));
			endif;
			?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
