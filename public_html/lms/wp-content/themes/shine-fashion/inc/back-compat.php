...
function templatemela_upgrade_notice() {
	$message = sprintf( esc_html__( 'TemplateMela requires at least WordPress version 3.6. You are running version %s. Please upgrade and try again.', 'shine-fashion' ), $GLOBALS['wp_version'] );
...
function templatemela_customize() {
	wp_die( sprintf( esc_html__( 'TemplateMela requires at least WordPress version 3.6. You are running version %s. Please upgrade and try again.', 'shine-fashion' ), $GLOBALS['wp_version'] ), '', array(
		'back_link' => true,
	) );
}
...
function templatemela_preview() {
	if ( isset( $_GET['preview'] ) ) {
		wp_die( sprintf( esc_html__( 'TemplateMela requires at least WordPress version 3.6. You are running version %s. Please upgrade and try again.', 'shine-fashion' ), $GLOBALS['wp_version'] ) );
	}
}
